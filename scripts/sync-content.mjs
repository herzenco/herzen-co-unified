...
const SITE_URL = (process.env.SITE_URL || "https://herzenco.com").replace(/\/$/, "");
...
function renderArticle(item, chrome) {
  ...
  const main = `<main id="main">
      <article class="content-article">
        ...
        <div class="container container-narrow">${hero}<div class="prose">${sanitizeMarkdown(item.body)}</div><footer class="content-article-footer"><a class="story-link" href="/resources/">← All field notes</a></footer></div>
      </article>
    </main>`;
